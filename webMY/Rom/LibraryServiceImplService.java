 ...
 * 
 */
@WebServiceClient(name = "LibraryServiceImplService", targetNamespace = "http://impl.service.web.epam.com/", wsdlLocation = "http://localhost:8080/RomanRunkovskyySOAPService-0.0.1-SNAPSHOT/service?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LIBRARYSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.web.epam.com/", "LibraryServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/RomanRunkovskyySOAPService-0.0.1-SNAPSHOT/service?wsdl");
    ...
    public LibraryService getLibraryServiceImplPort() {
        return super.getPort(new QName("http://impl.service.web.epam.com/", "LibraryServiceImplPort"), LibraryService.class);
    }
    ...
    public LibraryService getLibraryServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.web.epam.com/", "LibraryServiceImplPort"), LibraryService.class, features);
    }
